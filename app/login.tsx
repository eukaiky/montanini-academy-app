...
// Este é o seu IP, mantido do seu código.
...
// Salva os dados do usuário no contexto global do app.

            await signIn(resultado.usuario);



            console.log('Login bem-sucedido, usuário salvo no contexto:', resultado.usuario);



// O redirecionamento para a home agora é gerenciado automaticamente

// pelo seu arquivo _layout.tsx, então esta linha não é mais necessária.
...
// Não definimos setLoading(false) aqui porque o app irá

// navegar para outra tela, então não há necessidade.
